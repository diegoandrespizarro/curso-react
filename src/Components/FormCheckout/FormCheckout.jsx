...
export const FormCheckout = ({cart, getTotalPrice,clearCart, setOrderId}) => {
    ...
    return (
        <form onSubmit={handleSubmit}> 
            ...
            <input type="text" placeholder='Telefono' value={userData.phone} onChange={(e)=> setUserData({...userData, phone: e.target.value})}/>
